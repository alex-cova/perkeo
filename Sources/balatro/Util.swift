...
class Util {
    ...
    static func round13(_ x: Double) -> Double {
        ...
        if tentative != x && tentative != nextafter(x, 1)
            && truncated.truncatingRemainder(dividingBy: 1.0) >= 0.5
        {
    ...
    static func pseudohash(_ s: String) -> Double {
        ...
        for i in (0..<s.count).reversed() {
            ...
            num = fract(
                1.1239285023 / num * r * 3.141592653589793 + 3.141592653589793 * Double(i + 1))
        }
